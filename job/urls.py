...
urlpatterns=[
    ...
    # path('manager/notice/detail/', views.get_notice_detail.as_view()),
    ...
    path('teacher/homepage/password/', views.teacher_modify_password.as_view()),
    # path('teacher/notice/', views.teacher_get_notice_list.as_view()),
    # path('teacher/notice/detail/', views.teacher_get_notice_detail.as_view()),
    ...
    path('student/homepage/password/', views.student_modify_password.as_view()),
    # path('student/notice/', views.student_get_notice_list.as_view()),
    # path('student/notice/detail/', views.student_get_notice_detail.as_view()),
    ...
    # path('student/sign/add/', views.sign.as_view())
