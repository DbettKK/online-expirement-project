...
from .View.tea_homepage import teacher_course, teacher_modify_password, teacher_get_notice
from .View.tea_homework import teacher_get_homework_list, publish_homework, teacher_get_homework_detail, get_completed_list, get_completed_homework, manual_score, homework_analysis, delete_homework
from .View.tea_sign import teacher_get_sign_list, publish_sign, delete_sign, sign_detail


from .View.stu_homepage import student_course, student_modify_password, student_get_notice
from .View.stu_homework import student_get_homework, student_get_homework_detail, handin_homework, student_get_grade
from .View.stu_sign import student_get_sign, student_sign
