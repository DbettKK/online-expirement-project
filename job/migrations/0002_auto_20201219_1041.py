# Generated by Django 3.1 on 2020-12-19 10:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sign', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='job.sign', verbose_name='签到')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='job.student', verbose_name='签到学生')),
            ],
            options={
                'ordering': ['-SignTime'],
            },
        ...
        migrations.AddField(
            model_name='student',
            name='need_to_sign',
            field=models.ManyToManyField(related_name='sign_students', through='job.StudentSign', to='job.sign', verbose_name='需要完成的签到'),
        ),
        migrations.CreateModel(
            name='question',
            fields=[
